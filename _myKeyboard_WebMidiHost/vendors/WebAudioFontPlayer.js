...
({
1:[function(require,module,exports){'use strict'; console.log('WebAudioFont Channel v1.04');
...
if (typeof module === 'object' && module.exports) {	module.exports = WebAudioFontChannel;}
if (typeof window !== 'undefined') { window.WebAudioFontChannel = WebAudioFontChannel;}
},{}],

2:[function(require,module,exports){'use strict';	console.log('WebAudioFont Loader v1.17');
	...
	this.instrumentKeys = function () {
		if (!(this.instrumentKeyArray)) {
			this.instrumentKeyArray = [
				...
				'1270_JCLive_sf2_file', '1270_SBLive_sf2',
...
if (typeof module === 'object' && module.exports) {	module.exports = WebAudioFontLoader;}
if (typeof window !== 'undefined') {	window.WebAudioFontLoader = WebAudioFontLoader;}
},{}],

3:[function(require,module,exports){'use strict';	console.log('WebAudioFont Player v2.79');
...
function WebAudioFontPlayer() {
	...
	this.createChannel = function (audioContext) {return new WebAudioFontChannel(audioContext);};
	this.createReverberator = function (audioContext) {return new WebAudioFontReverberator(audioContext);};
	this.limitVolume = function (volume) {if (volume) {volume = 1.0 * volume;} else {volume = 0.5;}return volume;};
	...
	this.queueStrum = function (audioContext, target, preset, when, pitches, duration, volume, slides) {
		volume = this.limitVolume(volume);
		if (when < audioContext.currentTime) {when = audioContext.currentTime;}
		for (var i = 0; i < pitches.length; i++) {
	...
	this.queueWaveTable = function (audioContext, target, preset, when, pitch, duration, volume, slides) {
		...
		if (!(zone.buffer)) {console.log('empty buffer ', zone);return;}
		...
		var startWhen = when;
		if (startWhen < audioContext.currentTime) {startWhen = audioContext.currentTime;}
		var waveDuration = duration + this.afterTime;
		var loop = true;
		if(zone.loopStart < 1 || zone.loopStart >= zone.loopEnd) {loop = false;}
		if(!loop){if(waveDuration > zone.buffer.duration / playbackRate) {waveDuration = zone.buffer.duration / playbackRate;}}
		...
		} else {envelope.audioBufferSourceNode.loop = false;}
	...
	this.noZeroVolume = function (n) {if (n > this.nearZero) {return n;} else {return this.nearZero;}};
...
},{"./channel":1,"./loader":2,"./reverberator":4}],

4:[function(require,module,exports){'use strict';	console.log('WebAudioFont Reverberator v1.08');
...
if (typeof module === 'object' && module.exports) {	module.exports = WebAudioFontReverberator;}
if (typeof window !== 'undefined') {	window.WebAudioFontReverberator = WebAudioFontReverberator;}
},{}]},
